        ...
        child: Material(
          ...
          child: InkWell(
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  _MiniCover(isPlaying: snapshot.isPlaying),
                  ...
                  Semantics(
                    label: snapshot.isPlaying ? l10n.pause : l10n.play,
                    button: true,
                    child: IconButton(
                      icon: Icon(
                        snapshot.isPlaying ? AppIcons.pause : AppIcons.play,
                  ...
                  Semantics(
                    label: l10n.stopPlayback,
                    button: true,
                    child: IconButton(
                      icon: Icon(
                        AppIcons.stop,
                        color: isDark ? AppColors.muted : AppColors.ink.withValues(alpha: 0.45),
                        size: 20,
                      ),
...
class _MiniCover extends StatelessWidget {
  const _MiniCover({required this.isPlaying});
